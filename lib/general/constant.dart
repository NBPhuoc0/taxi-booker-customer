const String headPoint =
    "https://api-gateway.purplesand-fad3fa4f.southeastasia.azurecontainerapps.io";

// const String headPoint =
//     "http://192.168.0.112:8080"; // Giả lập xãi địa chỉ IP riêng thay vì localhost
...
class Customer {
  ...
  static const String getDriverLocation =
      "$headPoint/users/getDriverLocationByBR";
...
String key =
    "5b3ce3597851110001cf624886c5e7f702de408ba27c7a71dc294d4b"; // Openroute Service API
