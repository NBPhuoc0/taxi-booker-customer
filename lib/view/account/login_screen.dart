...
class _LoginScreenState extends State<LoginScreen> {
  TextEditingController phonenumberController =
      TextEditingController(text: "333495027");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: SafeArea(
          ...
          // --------------------- Trang trí ---------------------
          Positioned(
              top: -60, right: -60, child: circle(Colors.amber.shade600, 90)),
          Positioned(
              top: 30,
              left: 90,
              right: 45,
          ...
          Positioned(
              ...
              child: MaterialButton(
                ...
                child: Row(
                  ...
                  children: [
                    const Text("Chưa có tài khoản? Hãy ",
  ...
  Future<void> logIn() async {
    try {
      final status = await widget.accountViewmodel
          .updateLogIn(phonenumberController.text, passwordController.text);
      if (status) {
        widget.onLogIn();
      } else {
